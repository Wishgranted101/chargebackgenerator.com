...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ==================== USAGE LIMIT FUNCTIONS (DISABLED FOR TESTING) ====================
    ...
    // Form submission handler to save data before redirecting to PayPal
    form.addEventListener('submit', function(e) {
        // Prevent default submission to PayPal
        e.preventDefault();
        ...
        localStorage.setItem('chargebackFormData', JSON.stringify(formData));
        
        // 4. Submit the PayPal form
